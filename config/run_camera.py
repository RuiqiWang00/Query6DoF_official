...
SCHEDULER = dict(type='CosineAnnealingLR', T_max=249127*21//(86), eta_min=1e-6, last_epoch=-1, verbose=False)
TRAIN = dict(BEGIN_EPOCH=0, END_EPOCH=21, SAVE_EPOCH_STEP=4, VIS=False)